...
abstract contract LeverageMacroBase {
    ...
    function _doOperation(
        ...
        if (operation.amountToTransferIn > 0) {
            console2.log("transfer operation.amountToTransferIn");
        ...
        if (flType == FlashLoanType.eBTC) {
            ...
            console2.log("loan stETH");
            console2.log("before loan balance: ", stETH.balanceOf(address(this)));
            ...
            console2.log("after loan balance: ", stETH.balanceOf(address(this)));
        } else {
    ...
    function _handleOperation(LeverageMacroOperation memory operation) internal {
        console2.log("\n LeverageMacroBase._handleOperation...");
        uint256 beforeSwapsLength = operation.swapsBefore.length;
        console2.log("beforeSwapsLength :", beforeSwapsLength );
        ...
        console2.log("afterSwapsLength: ", afterSwapsLength );
    ...
    function onFlashLoan(
        ...
        console2.log("\n calling back LeverageMacroBase.onFlashLoan...");
        console2.log("collateral balance: ", stETH.balanceOf(address(this)));
    ...
    function _openCdpCallback(bytes memory data) internal virtual {
        console2.log("\n LeverageMacroBase._openCdpCallback...");
    ...
    function excessivelySafeCall(
        ...
        uint256 _toCopy;
        bool _success;
        bytes memory _returnData = new bytes(_maxCopy);   // number of bytes for returnData
